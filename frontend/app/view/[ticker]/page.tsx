...
>
  AI Assistant
      ...
      <TableContainer component={Paper} sx={{
        position: 'absolute', left: '136px', top: '785px', width: '809px', height: '185px',
        background: '#404040', borderRadius: '20px', overflowY: 'auto', padding: '10px',
      }}>
        <Table>
          <TableHead>
            <TableRow>
          ...
          <TableBody>
            {Array.isArray(newsData) && newsData.length > 0 ? (
              newsData.map((news, index) => (
                <TableRow key={index}>
                  <TableCell sx={{ color: '#fff', borderBottom: '1px solid #181818' }}>{news.title}</TableCell>
                </TableRow>
              ))
            ) : (
              <>
                <TableRow>
                  <TableCell sx={{ color: '#fff', textAlign: 'center', padding: '20px', background: '#404040' }}>Story 1</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell sx={{ color: '#fff', textAlign: 'center', padding: '20px', background: '#404040' }}>Story 2</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell sx={{ color: '#fff', textAlign: 'center', padding: '20px', background: '#404040' }}>Story 3</TableCell>
                </TableRow>
              </>
            )}
          </TableBody>
